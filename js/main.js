...
const JOURNEY_STEPS = [
  {
    ...
    thumb:'hero-plat.png', url:'https://youtu.be/CBIodAb0ra4',
    gradient:'linear-gradient(135deg,#3D1A6E,#6B34C5)'
  },
  {
    icon:'<img src="assets/icons/Asset 3.svg" alt="يتفاعل مع الأستاذ" class="journey-step-icon">', label:'يتفاعل مع الأستاذ',
    title:'يتفاعل مع الأستاذ',
    desc:'حصص مباشرة للإجابة على الأسئلة وتثبيت الفهم — تفاعل حقيقي مع الأستاذ في الوقت الفعلي.',
    thumb:'explain-plat.png', url:'https://www.youtube.com/watch?v=ZK-rNEhJIDs',
  ...
  },
  {
    ...
    thumb:'hero-plat.png', url:'https://www.youtube.com/watch?v=v3zIeUkLrrA',
  ...
  },
  {
    ...
    thumb:'explain-plat.png', url:'https://youtu.be/lcRd_OS4G-I',
  ...
  },
  {
    ...
    thumb:'hero-plat.png', url:'PLATFORM_VIDEO_5',
